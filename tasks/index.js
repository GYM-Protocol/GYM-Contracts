...
// 		const gymVaultsBank = await ethers.getContractAt("GymVaultsBank", taskArgs.bank, accounts.deployer);
...
// 	.setAction(async (taskArgs) => {
// 		const accounts = await ethers.getNamedSigners();
// 		const router = await ethers.getContractAt("IPancakeRouter02", taskArgs.router);
// 		const token = await ethers.getContractAt("GymToken", taskArgs.token);
...
// 	const accounts = await ethers.getNamedSigners();
// 	const routerAddress = "0x367633909278A3C91f4cB130D8e56382F00D1071";
// 	const router = await ethers.getContractAt("IPancakeRouter02", routerAddress);
// 	const gymToken = await ethers.getContract("GymToken", accounts.deployer);
...
// 	const accounts = await ethers.getNamedSigners();
// 	const WBNB = variables.contracts[2];
// 	const BUSD = variables.contracts[5];
// 	const routerAddress = variables.contracts[0];

// 	const router = await ethers.getContractAt("IPancakeRouter02", routerAddress);
// 	const factory = await ethers.getContractAt("IPancakeFactory", await router.factory());
// 	const gymToken = await ethers.getContract("GymToken");
// 	const busdToken = await ethers.getContractAt("GymToken", BUSD);
// 	const bank = await ethers.getContract("GymVaultsBank");
// 	const buyBack = await ethers.getContract("BuyBack");
// 	const farming = await ethers.getContract("GymFarming");
// 	const strategy = await ethers.getContract("GymVaultsStrategyAlpaca");
// 	const strategyBUSD = await ethers.getContract("GymVaultsStrategyAlpacaBUSD");
// 	const gymMLM = await ethers.getContract("GymMLM");
